...
export function TopAppBar({cur, setCur}: {cur: string; setCur: Function}) {
  return (
    <div className="z-30 flex h-20 w-screen flex-row items-center justify-around gap-2 bg-secondary-400 p-2 shadow-md lg:h-screen lg:w-28 lg:flex-col lg:justify-start">
